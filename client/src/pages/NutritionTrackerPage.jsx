  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-pink-50 to-blue-50">
      ...
      <div className="flex-1">
        ...
        {/* Added pt-16 to offset fixed header height */}
        <div className="flex min-h-screen items-start justify-center pt-16 lg:pt-24 p-4">
          <div className="w-full max-w-4xl space-y-8 rounded-3xl bg-white/90 p-6 sm:p-8 shadow-xl backdrop-blur-md animate-fade-in border border-pink-200">
