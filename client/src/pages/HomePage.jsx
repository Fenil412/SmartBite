...
export default function HomePageContent({ navigate, isDarkMode }) {
  ...
  return (
    <>
      {/* Hero Section */}
      <section
        className={`relative pt-2 pb-20 lg:pt-32 lg:pb-32 overflow-hidden ${
        ...
        <div className="absolute inset-0">
          <div
            className={`absolute inset-0 ${
              isDarkMode
                ? "bg-gray-950"
                : "bg-gradient-to-br from-orange-100/50 via-pink-100/50 to-blue-100/50"
            }`}
          ></div>
          <div
            className={`absolute top-1/4 left-1/4 w-72 h-72 ${
              isDarkMode
                ? "bg-purple-900/40"
                : "bg-gradient-to-r from-pink-200/40 to-orange-200/40"
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="space-y-8">
                <div
                  className={`inline-flex items-center gap-2 px-4 py-2 rounded-full border shadow-sm ${
                    isDarkMode
                      ...
                      : "bg-gradient-to-r from-pink-100 to-orange-100 border-pink-200/50"
                  }`}
                >
                  <Sparkles
                    className={`w-4 h-4 ${
                ...
                >
                  Transform your nutrition journey with AI-powered meal plans,
                  automated shopping lists, and personalized recipes that adapt
                  to your lifestyle.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-5">
                ...
                <button
                  className={`group px-8 py-4 rounded-2xl font-bold text-lg hover:shadow-lg transition-all duration-300 flex items-center justify-center ${
                    isDarkMode
                      ? "bg-gray-700 text-gray-100 border-2 border-gray-600 hover:border-gray-500 hover:bg-gray-600"
              ...
              <div
                className={`grid grid-cols-3 gap-6 pt-6 border-t ${
                  isDarkMode ? "border-gray-700" : "border-pink-200/50"
                }`}
              >
                {[
            ...
            <div className="relative lg:pl-8">
              ...
              <div className="relative">
                ...
                <div
                  className={`relative rounded-3xl p-6 shadow-xl border ${
                    isDarkMode
                      ? "bg-gray-800/80 backdrop-blur-xl border-gray-700"
                      : "bg-white/80 backdrop-blur-xl border-pink-200/50"
                  }`}
                >
      ...
      <section
        className={`py-20 ${isDarkMode ? "bg-gray-900/70" : "bg-white/70"}`}
      >
        <div className="container mx-auto px-4">
          <div className="text-center space-y-5 mb-16">
            ...
            >
              ...
              continuously adapts to deliver the perfect nutrition experience
            </p>
          </div>
                ...
                <div
                  ...
                  className={`p-5 rounded-2xl border-2 transition-all duration-500 cursor-pointer ${
                    activeFeature === index
                      ? `${
                          isDarkMode
                            ? "border-pink-700 bg-gray-800 shadow-xl scale-105"
                      ...
                      <div className="space-y-5">
                        <div
                          className={`p-4 rounded-xl border text-center ${
                            isDarkMode
                              ? "bg-gray-700 border-gray-600"
                              : "bg-gradient-to-r from-pink-100 to-orange-100 border-pink-200"
                          }`}
                        >
                          <div
      ...
      >
        <div className="container mx-auto px-4">
          <div className="text-center space-y-5 mb-16">
            ...
            >
              Get started with personalized meal planning in three effortless
              steps
            </p>
          </div>
              ...
              <div key={index} className="relative group">
                <div className="text-center space-y-6">
                  <div className="relative mx-auto">
                    ...
                    <div
                      className={`absolute -top-1 -right-1 w-8 h-8 rounded-full border-2 flex items-center justify-center shadow-lg ${
                        isDarkMode
                          ? "bg-gray-700 border-gray-600"
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {testimonials.map((testimonial, index) => (
              <div
                key={index}
                className={`p-6 rounded-2xl shadow-xl border hover:shadow-2xl transition-all duration-300 hover:scale-105 ${
                  isDarkMode
                    ? "bg-gray-800/90 backdrop-blur-xl border-gray-700"
                    : "bg-white/90 backdrop-blur-xl border-pink-200/50"
                }`}
        ...
        <div className="container mx-auto px-4 relative">
          <div className="text-center space-y-8 max-w-4xl mx-auto">
            ...
            <p className="text-xl lg:text-2xl mb-8 font-bold opacity-90">
              Join 50,000+ users who've already achieved their nutrition goals
              with Smart Bite
            </p>
