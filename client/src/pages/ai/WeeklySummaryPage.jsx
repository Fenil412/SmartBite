...
const WeeklySummaryPage = () => {
  ...
  const generateSummary = async () => {
    if (!selectedPlan) {
      setError('Please select a meal plan to summarize')
      return
    }
    ...
    try {
      ...
      const response = await flaskAiService.summarizeWeeklyMeal(user._id, selectedPlan)
    ...
    <div className="p-6 max-w-4xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Get AI-generated insights and improvements for your weekly meal plans
        </p>
        <div className="mt-2 text-sm text-gray-500 dark:text-gray-400">
          ⚠️ AI-generated summary • Review and adapt to your needs
        </div>
      </div>
      ...
      <div className="mb-8">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">
          Select a Meal Plan to Summarize
        </h2>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-sm text-gray-500 mt-1">
                      {plan.days?.length || 0} days planned • {plan.totalMeals || 0} meals
                    </div>
                  </div>
                  {selectedPlan?._id === plan._id && (
        ...
        <div className="space-y-6">
          ...
          {selectedPlan && (
            <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Week of {formatDate(selectedPlan.weekStartDate)}
              </p>
            </div>
          )}
